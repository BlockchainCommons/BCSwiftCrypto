...
struct HashTests {
    ...
    @Test func testSHA() {
        ...
        #expect(digest256.hex == "248d6a61d20638b8e5c026930c3e6039a33ce45964ff2167f6ecedd419db06c1")
        let digest512 = SHA512.hash(input.utf8Data)
        #expect(digest512.hex == "204a8fc6dda82f0a0ced7beb8e08a41657c16ef468b228a8279be331a703c33596fd15c13b1b07f9aa1d3bea57789ca031ad85c7a71dd70354ec631238ca3445")
    }
    
    @Test func testHMACSHA() {
        ...
        #expect(hmac256 == ‡"b0344c61d8db38535ca8afceaf0bf12b881dc200c9833da726e9376c2e32cff7")
        let hmac512 = SHA512.hmac(key: key, message: message)
        #expect(hmac512 == ‡"87aa7cdea5ef619d4ff0b4241a1d6cb02379f4e2ce4ec2787ad0b30545e17cdedaa833b7d6b8a702038b274eaea3f4e4be9d914eeb61f1702e696c203a126854")
    }
    
    @Test func testPBKDF2HMACSHA256() {
        let key = SHA256.pbkdf2HMAC(pass: "password".utf8Data, salt: "salt".utf8Data, iterations: 1, keyLen: 32)
        #expect(key == ‡"120fb6cffcf8b32c43e7225256c4f837a86548c92ccc35480805987cb70be17b")
    }
    
    @Test func testHKDFHMACSHA256() {
        let message = "hello".utf8Data
        let salt = ‡"8e94ef805b93e683ff18"
        let key = SHA256.hkdfHMAC(keyMaterial: message, salt: salt, keyLen: 32)
        #expect(key == ‡"13485067e21af17c0900f70d885f02593c0e61e46f86450e4a0201a54c14db76")
    }

    @Test func testCRC32() {
        let input = "Hello, world!".utf8Data
        let checksum = CRC32.hash(input)
        #expect(checksum == 0xebe6c6e6)
        #expect(CRC32.hashData(input) == ‡"ebe6c6e6")
        #expect(CRC32.hashData(input, littleEndian: true) == ‡"e6c6e6eb")
    }
